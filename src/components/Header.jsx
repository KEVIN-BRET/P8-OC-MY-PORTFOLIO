...
const StyledPopupBanner = styled.div`
  ...
  & .bannerText {
    ...
    max-width: calc(
      100% - 3rem
    ); /* laisse un espace pour le bouton de fermeture */
...
export default function Header() {
  ...
  return (
    <>
        ...
        {isBannerVisible && (
          <StyledPopupBanner>
            <p className="bannerText">
              Je suis actuellement à la recherche de ma première opportunité en
              tant que développeur Front-End junior. N'hésitez pas à explorer
              mes réalisations ci-dessous et à me contacter si vous êtes
              intéressé par mon profil <span>😉</span>
            </p>
      ...
      <StyledBacToTop
        $isDarkMode={darkMode}
        className={isScrolled ? "page--scrolled" : ""}
      >
        <a href="#accueil">
